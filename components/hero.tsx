...
function AnimatedCircle({
  ...
  return (
    <div
      className={`absolute w-[${size}px] h-[${size}px] rounded-full bg-primary/${intensity} animate-pulse`}
          ...
          {isMounted && (
            <div className="relative w-full h-full rounded-xl overflow-hidden from-primary/5 to-primary/10">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {/* <AnimatedCircle size={300} delay="150ms" intensity={5} />
                <AnimatedCircle size={500} delay="300ms" intensity={5} />
                <AnimatedCircle size={450} delay="450ms" intensity={10} />
                <AnimatedCircle size={400} delay="600ms" intensity={15} /> */}
